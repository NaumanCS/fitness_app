                ...
                <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-section">
                            <h4 class="menu-text">Apps & Pages</h4>
                        ...
                        <li class="menu-item {{ request()->is('goal*') ? 'menu-item-active' : '' }}"
                            aria-haspopup="true">
                            <a href="{{ route('goals.index') }}" class="menu-link">
                                ...
                                <span class="menu-text">User Goals</span>
                            </a>
                        </li>

                        <li class="menu-item {{ request()->is('diet*') ? 'menu-item-active' : '' }}"
                            aria-haspopup="true">
                            <a href="{{ route('diet.index') }}" class="menu-link">
                                <span class="svg-icon menu-icon">
                                ...
                                <span class="menu-text">Diet</span>
                            </a>
                        </li>

                        <li class="menu-item {{ request()->is('intensity*') ? 'menu-item-active' : '' }}"
                            aria-haspopup="true">
                            <a href="{{ route('intensity.index') }}" class="menu-link">
                                <span class="svg-icon menu-icon">
                                ...
                                <span class="menu-text">Intensity</span>
                            </a>
                        </li>

                        <li class="menu-item {{ request()->is('food*') ? 'menu-item-active' : '' }}"
                            aria-haspopup="true">
                        ...
                        <li class="menu-item {{ request()->is('active-state*') ? 'menu-item-active' : '' }}"
                            aria-haspopup="true">
                            <a href="{{ route('active.state.index') }}" class="menu-link">
                                <span class="svg-icon menu-icon">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/General/Settings-1.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                ...
                                <span class="menu-text">Active State</span>
                            </a>
                        </li>
                        ...
                        <li class="menu-item {{ request()->is('general/settings') ? 'menu-item-active' : '' }}"
                            aria-haspopup="true">
                            <a href="{{ route('general.settings.create') }}" class="menu-link">
                                <span class="svg-icon menu-icon">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Home/Library.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        <li class="menu-item {{ request()->is('about-us*') ? 'menu-item-active' : '' }}"
                            aria-haspopup="true">
                        ...
                        <li class="menu-item {{ request()->is('policy*') ? 'menu-item-active' : '' }}"
                            aria-haspopup="true">
                            <a href="{{ route('policy.index') }}" class="menu-link">
                                ...
                                <span class="menu-text">Legal & Policies</span>
                            </a>
                        </li>

                        <li class="menu-item {{ request()->is('faq*') ? 'menu-item-active' : '' }}"
                            aria-haspopup="true">
