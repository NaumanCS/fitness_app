        ...
        <div class="topbar">
            ...
            <div class="topbar-item">
                <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2"
                    ...
                    <span
                        class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{ Str::studly($name) }}</span>
                    <div class="dropdown">
                        <span
                            class="d-flex align-items-center symbol symbol-lg-35 symbol-25 symbol-light-success dropdown-toggle"
