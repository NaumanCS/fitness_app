        ...
        <div class="d-flex flex-column-fluid">
            <div class="container">
                <div class="card card-custom">
                    ...
                    <!--begin::Form-->
                    <form class="form" method="POST" action="{{route('food.submit', $update_id)}}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="calories" class="form-control" placeholder="Enter Calories Here:" value="{!! $obj->calories ?? '' !!}" />
                            </div>
                        </div>
